...
const Header = function () {
  ...
  const purchaseSection = useScrollSection('purchase-section');
  const buySection = useScrollSection('mint-nft-section');
  const historySection = useScrollSection('last-winner-section');
  const faqSection = useScrollSection('faq-container');
          ...
          <BreakpointProvider>
            <Breakpoint l down>
              <Popover
                ...
                <div className='navbar-item'>
                  <span onClick={() => {purchaseSection.onClick(); handleClose();}} selected={purchaseSection.selected}>
                    STATISTICS
                  </span>
                </div>
                <div className='navbar-item'>
                ...
                <div className='navbar-item'>
                  <span onClick={() => {historySection.onClick(); handleClose();}} selected={historySection.selected}>
                    WINNERS
                  </span>
                </div>
                <div className='navbar-item'>
                  <span onClick={() => {faqSection.onClick(); handleClose();}} selected={faqSection.selected}>
                    FAQ
                  </span>
                </div>
              </Popover>
            ...
            <Breakpoint xl>
              <div className='menu'>
                ...
                <div className='navbar-item'>
                  <span onClick={purchaseSection.onClick} selected={purchaseSection.selected}>
                    STATISTICS
                    <div className='lines'></div>
                  </span>
                </div>
                ...
                <div className='navbar-item'>
                  <span onClick={historySection.onClick} selected={historySection.selected}>
                    WINNERS
                  </span>
                </div>
                <div className='navbar-item'>
                  <span onClick={faqSection.onClick} selected={faqSection.selected}>
                    FAQ
                    <div className='lines'></div>
                  </span>
                </div>
