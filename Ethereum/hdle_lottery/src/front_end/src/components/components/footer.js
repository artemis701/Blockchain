                    ...
                    <div className="col-md-12">
                        <div className="de-flex">
                            <span onClick={() => window.open("", "_self")}>
                                <img alt="" className="f-logo d-1" src="./img/logo-footer.png" width="110" />
                            </span>
                            <span className="copy">Copyright &copy; 2022 <span className='c-more'>HODL Lottery</span> All Rights Reserved</span>
