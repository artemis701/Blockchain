...
const faqData = [
  {
    title: `What's ASTRO's utility?`,
    content: `ASTRO will be an auto-staking token working hard to grow in quantity with every 30 minute rebase to accrue 1.91085...% a day for every wallet holding it.`
  },
  {
